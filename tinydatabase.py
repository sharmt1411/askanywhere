...
class TinyDatabase:
    ...
    # 自定义：
    # "日总结"
    # "#学习", "#笔记", "#作业", "#考试", "#复习", "#课程", "#阅读", "#研究", "#项目", "#实验",
    # "#工作", "#任务", "#会议", "#报告", "#项目管理", "#客户", "#同事", "#进度", "#文档", "#演示",
    # "目标", "技能", "培训", "自我提升", "健康", "锻炼", "饮食", "睡眠", "习惯", "心情",
    # "日程", "计划", "提醒", "待办", "重要", "紧急", "长远目标", "短期目标", "高优先级",
    # "购物", "旅行", "娱乐", "家庭", "朋友", "生日", "纪念日", "节日", "财务",
    # "编程", "代码", "开发", "调试", "技术文档", "工具", "框架", "库", "算法", "数据",
    # "创意", "灵感", "设计", "艺术", "音乐", "摄影", "写作", "绘画", "手工", "项目构思",
    # "社交", "网络", "联系", "邮件", "电话", "会议", "活动", "聚会", "社交媒体", "社区",
    # "收入", "支出", "投资", "储蓄", "预算", "账单", "税务", "理财", "保险",
    # "参考", "资源", "链接", "文件", "图片", "总结", "询问记录"
    # "中优先级", "低优先级", "读书笔记", "#待办", "#进行中", "#已完成", "#暂停", "#取消", "待处理", "草稿"
    # "#愉快", "#有挑战", "#灵感", "#反思", "#图书", "#论文", "#文章", "#视频", "#网站"
    # "#截止日期", "#会议日期", "#纪念日", "#计划日期"
...
class RecordSearcher:
    ...
    def search_records(self, params):
        ...
        combine_tags = params.get("combine_tags", "AND")
